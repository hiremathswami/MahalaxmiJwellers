...
export const products: Product[] = [
  ...
  {
    id: '14',
    slug: 'mens-classic-curb-silver-chain',
    ...
    isNew: true,
    isBestSeller: true,
    collectionId: 'mens-collection',
    gender: 'men',
    description: 'A bold handcrafted 925 sterling silver curb chain necklace for men. Features durable precision-cut links with a high-polish finish and sturdy lobster clasp.',
    details: {
      productDetails: 'Width: 5mm. Length: 22 inches. Closure: Heavy-duty lobster clasp.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Wipe with a soft polishing cloth. Avoid harsh chemicals.',
    },
  },
  {
    id: '15',
    slug: 'mens-sovereign-signet-silver-ring',
    name: "Men's Sovereign Signet Silver Ring",
    price: 3200,
    originalPrice: 3900,
    category: 'Rings',
    metal: '925 Sterling Silver',
    ...
    description: 'A minimalist 925 sterling silver signet ring for men featuring a flat polished face with brushed side profiles. Solid, comfortable, and classic.',
    details: {
      productDetails: 'Face dimensions: 12mm x 10mm. Solid back construction for comfort fit.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Clean with warm soapy water and soft brush.',
    },
  },
  {
    id: '16',
    slug: 'mens-royal-silver-kada-bracelet',
    name: "Men's Royal Silver Kada Bracelet",
    price: 5800,
    originalPrice: 6900,
    category: 'Bracelets',
    metal: 'Oxidized Sterling Silver',
    ...
    collectionId: 'mens-collection',
    gender: 'men',
    description: 'Heavyweight 925 sterling silver kada bracelet crafted for men, featuring contoured bevel edges and an antique oxidized finish.',
    details: {
      productDetails: 'Thickness: 6mm. Inner Diameter: 65mm. Slip-on kada style.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Store in provided box when not in use.',
    },
  },
  {
    id: '17',
    slug: 'mens-black-onyx-crest-pendant-chain',
    name: "Men's Black Onyx Crest Pendant Chain",
    price: 4200,
    originalPrice: 4900,
    category: 'Chains',
    metal: '925 Sterling Silver',
    stone: 'Onyx',
    weight: '14.1g',
    images: ['/uploads/1784044928818-Man_wearing_silver_rope_chain_202607142120.jpeg'],
    rating: 4.7,
    reviewCount: 29,
    inStock: true,
    isNew: true,
    ...
    collectionId: 'mens-collection',
    gender: 'men',
    description: 'Geometric natural black onyx stone framed in polished 925 sterling silver, suspended from an adjustable wheat chain for men.',
    details: {
      productDetails: 'Pendant size: 20mm x 15mm. Chain length: 20 inches + 2 inch extender.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Avoid dropping on hard surfaces.',
    },
  },
  {
    id: '18',
    slug: 'mens-braided-silver-chain-bracelet',
    name: "Men's Braided Silver Chain Bracelet",
    price: 3800,
    originalPrice: 4500,
    category: 'Bracelets',
    metal: '925 Sterling Silver',
    ...
    collectionId: 'mens-collection',
    gender: 'men',
    description: 'Intricately woven 925 sterling silver wheat-style braided chain bracelet with a heavy hook lock, built for daily wear.',
    details: {
      productDetails: 'Width: 4.5mm. Length: 8 inches. Closure: S-hook clasp.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Polish periodically with soft cloth.',
    },
  },
  {
    id: '19',
    slug: 'mens-brushed-matte-band-ring',
    name: "Men's Brushed Matte Silver Band Ring",
    price: 2800,
    originalPrice: 3400,
    category: 'Rings',
    metal: '925 Sterling Silver',
    ...
    gender: 'men',
    sizes: [7, 8, 9, 10, 11, 12],
    description: 'Contemporary 925 sterling silver band ring featuring a satin brushed surface with polished bevel edges.',
    details: {
      productDetails: 'Band width: 6mm. Comfort fit interior.',
      hallmark: '925 Hallmarked Sterling Silver.',
      delivery: 'Complimentary insured shipping within India.',
      care: 'Store separately to maintain brushed texture.',
    },
  },
];
